...
('Jane', 'Doe', 'jane.doe@email.com', 'jane.doe', '$2a$10$EWCHlBNT.zK/6CMyHrh8Q.91W7uOlOhXKGxcTkk2Z/H0VExd3gV42', '555-0102', 'staff'), -- password123
...
('ABC1234', 'Toyota Camry', 'Blue', 1),
('XYZ7890', 'Honda Civic', 'Red', 1),
('STAFF01', 'Ford Fusion', 'Black', 2),
('FAMCAR1', 'Chevrolet Malibu', 'White', 2);
...
('CIT-2023-001', '2023-10-15', 'Expired Parking Meter', 45.00, 'Paid', 1),
('CIT-2024-001', '2024-03-10', 'No Parking Permit Displayed', 75.00, 'Unpaid', 2),
('CIT-2024-002', '2024-02-20', 'Parked in Handicap Zone', 250.00, 'Unpaid', 4);